...
Route::group(array('prefix' => 'shop','Permission'=>"shop_management", 'as' => 'shop::'), function() {
    Route::any('list', ['as' => 'indexShop', 'uses' => 'ShopController@index']);
    Route::get('add', ['as' => 'createShop', 'uses' => 'ShopController@create']);
    Route::get('edit/{id}', ['as' => 'editShop', 'uses' => 'ShopController@edit']);
    Route::post('delete', ['as' => 'deleteShop', 'uses' => 'ShopController@delete']);
    Route::post('store', ['as' => 'storeShop', 'uses' => 'ShopController@store']);
    Route::post('update', ['as' => 'updateShop', 'uses' => 'ShopController@update']);
    Route::post('change_status', ['uses' => 'ShopController@changeStatus']);
    Route::post('datatable', ['uses' => 'ShopController@datatable']);
    Route::post('employee_list', ['uses' => 'EmployeeController@getEmployeeList']);
});

Route::group(array('prefix' => 'product','Permission'=>"product_management", 'as' => 'product::'), function() {
    Route::any('list', ['as' => 'indexProduct', 'uses' => 'ProductController@index']);
    ...
    Route::post('change_status', ['uses' => 'ProductController@changeStatus']);
