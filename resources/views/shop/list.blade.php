...
@section('pageTitle')
    {{__('app.default_list_title',["app_name" => __('app.app_name'),"module"=> __('app.shop')])}}
@endsection
...
@section('content')
    <div class="be-content">
        <div class="page-head">
            <h2>{{trans('app.shop')}}</h2>
            <ol class="breadcrumb">
                <li><a href="{{url('/dashboard')}}">{{trans('app.admin_home')}}</a></li>
                <li class="active">{{trans('app.shop')}} Listing</li>
            </ol>
        </div>
        <div class="main-content container-fluid">
            ...
            <div class="panel panel-default panel-border-color panel-border-color-primary pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('/shop/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.shop')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                ...
                <div class="deta-table shop-table pull-left">
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="panel-body">
                                    <table id="dataTable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="no-sort">count of product</th>
                                            <th>status</th>
...
@push('internalJsLoad')
<script>
    app.default.init({"route": {"url": 'shop/datatable'}});
</script>
@endpush